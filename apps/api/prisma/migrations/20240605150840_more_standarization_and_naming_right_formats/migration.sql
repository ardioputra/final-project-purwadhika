...
-- DropForeignKey
ALTER TABLE `discount` DROP FOREIGN KEY `Discount_product_id_fkey`;
...
-- DropForeignKey
ALTER TABLE `inventory` DROP FOREIGN KEY `Inventory_store_id_fkey`;

-- DropForeignKey
ALTER TABLE `item` DROP FOREIGN KEY `Item_cart_id_fkey`;

-- DropForeignKey
ALTER TABLE `item` DROP FOREIGN KEY `Item_product_id_fkey`;
...
-- DropForeignKey
ALTER TABLE `product` DROP FOREIGN KEY `Product_admin_id_fkey`;

-- DropForeignKey
ALTER TABLE `product` DROP FOREIGN KEY `Product_category_id_fkey`;

-- DropForeignKey
ALTER TABLE `referral` DROP FOREIGN KEY `Referral_referral_id_fkey`;

-- DropForeignKey
ALTER TABLE `referral` DROP FOREIGN KEY `Referral_referrer_id_fkey`;

-- DropForeignKey
ALTER TABLE `referral` DROP FOREIGN KEY `Referral_voucher_id_fkey`;
